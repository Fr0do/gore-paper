...
\subsection{E3: Representation Analysis (Future Work)}
\label{sec:e3}

Spectral decomposition of residual-stream activations conditioned on
\textsc{Fork}/\textsc{Cut}/\textsc{Step} node types is deferred to future work.
We plan to apply PCA/SVD to test whether backtracking occupies a distinguishable
representational subspace and whether ablating that direction selectively
degrades backtrack accuracy.
