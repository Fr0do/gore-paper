...
\begin{enumerate}
  ...
  \item \textbf{Spectral-R1 analysis.}
    Spectral decomposition of residual-stream activations conditioned on
    \textsc{Fork}/\textsc{Cut}/\textsc{Step} node types, providing mechanistic
    evidence that backtracking occupies a distinguishable representational
    subspace.
\end{enumerate}
